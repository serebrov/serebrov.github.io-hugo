...
* A) Consumer requests Request Token
  * call `get_request_token` from Service Provider, send
    ...
    * both sides (Consumer and Service Provider) know consumer_secret and able to perform this operation, so Service Provider can check whether signature is valid
